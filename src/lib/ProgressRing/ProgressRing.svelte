<script lang="ts">
	...
	// Clamp value without mutating the prop directly
	$: clampedValue = value < 0 ? 0 : value > 100 ? 100 : value;
</script>
...
<svg
	...
	height={size}
	viewBox="0 0 16 16"
	role={clampedValue ? "progressbar" : "status"}
...
>
	<circle
		...
		r="7"
		stroke-dasharray="3"
		stroke-dashoffset={((100 - clampedValue) / 100) * circumference}
	/>
</svg>
